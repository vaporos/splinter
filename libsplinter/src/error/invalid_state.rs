...
/// An error returned when an operation cannot be completed because the state of the struct is
/// inconsistent.
///
/// This can occur by a caller when a sequence of functions is called in a way that results in a
/// file state which is inconsistent.
///
